...
urlpatterns = [
    ...
    path('password_reset', views.PasswordResetView.as_view(email_template_name="user_template/password_reset_email.html",
         template_name="user_template/password_reset_form.html",
